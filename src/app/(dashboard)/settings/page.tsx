            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Smartphone className="mt-3 h-4 w-4 text-muted-foreground" />
                    <Input
                      id="phone"
                      value={profile.phone}
            ...
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="orgSlug" defaultValue="demo-org" />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="orgDescription">Description</Label>
                  <Input id="orgDescription" defaultValue="Production cloud infrastructure" />
                </div>
                <div className="space-y-2">
              ...
              <CardContent className="space-y-6">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Receive alerts about your resources via email</p>
                  </div>
                  <Switch
